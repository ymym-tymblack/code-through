...
[bold #CD7F32]║[/]  [#FFBF00]Explain · Flow · Review[/] [dim #B8860B]Code-Through[/]   [bold #CD7F32]║[/]
[bold #CD7F32]╚══════════════════════════════════════════════════════════════╝[/]
"""
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]Code-Through[/]")
    ...
    agent_name = _skin_branding("agent_name", "Code-Through")
