...
COMMANDS_BY_CATEGORY = {
    "Session": {
        ...
        "/sync": "Manage automatic codebase sync (usage: /sync [on|off|status|now|last [flow|explain|review|diff]])",
        "/review": "Manage automatic review and exclusions (usage: /review [on|off|status|last|apply|promote|exclude ...])",
        "/explain": "Explain a file in natural language (usage: /explain <path>)",
        "/flow": "Explain a symbol or flow (usage: /flow <symbol> [path])",
        "/diff": "Explain the current change diff in detail (usage: /diff [extra guidance])",
        "/commit": "Compatibility alias for /diff",
...
COMMAND_OPTIONS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "/sync": (
        ("on", "Enable automatic codebase sync"),
        ("off", "Disable automatic codebase sync"),
        ("status", "Show sync status for all panes"),
        ("now", "Run the startup sync immediately"),
        ("last", "Show the last stored flow/explain/review/diff pane"),
    ),
    "/review": (
