...
class TestCommitCommand:
    ...
    def test_commit_command_prints_message_outside_git_repo(self, tmp_path, capsys):
        ...
        HermesCLI._handle_commit_command(cli_obj, "/commit")
    ...
    def test_commit_command_builds_prompt_from_current_diff(self, tmp_path):
        ...
        assert cli_obj._run_review_prompt.call_args.kwargs["command_name"] == "commit"
        assert cli_obj._run_review_prompt.call_args.kwargs["title"] == "Commit Message"
    ...
    def test_commit_command_includes_extra_instruction(self, tmp_path):
        ...
        HermesCLI._handle_commit_command(cli_obj, "/commit emphasize the user-facing behavior")
